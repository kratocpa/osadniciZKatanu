...
namespace osadniciZKatanu
{
    public class PlayerDesc
    {
        ...
        public GameDesc.color Color { get; protected set; } // barva hráče
        ...
        public List<GameDesc.materials> PortForMaterial { get; set; } // hráč má vesnici na přístavu se surovinou (může pro tuto surovinu využívat směný kurz 2:1)

        public PlayerDesc(GameDesc.color playerColor, bool real, GameProperties gmProp)
        {
            Color = playerColor;
            RealPlayer = real;
            LargestArmy = false;
            ...
            UniversalPort = false;
            PortForMaterial = new List<GameDesc.materials>();
        }
