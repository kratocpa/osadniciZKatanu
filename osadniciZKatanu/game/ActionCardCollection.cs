...
namespace osadniciZKatanu
{
    public class ActionCardCollection : ActionCardCollectionDesc, ICloneable
    {
        ...
        public void RaiseQuantity(GameDesc.actionCards raisedActCard, int umbel)
        {
        ...
        public void DecreaseQuantity(GameDesc.actionCards decreaseActCard, int umbel)
        {
        ...
        public void SetQuantity(GameDesc.actionCards setActCard, int setValue)
        {
        ...
        public void AddActionCard(GameDesc.actionCards addedActCard)
        {
            RaiseQuantity(addedActCard, 1);
        }

        public void DeleteActionCard(GameDesc.actionCards deletedActCard)
        {
